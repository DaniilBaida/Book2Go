<x-business-layout>
    <div class="p-6 bg-white shadow sm:rounded-lg">
        ...
        <form method="POST" action="{{ route('business.discounts.store') }}">
            @csrf
            <div class="mb-4">
            ...
            <div class="flex justify-end mt-6">
                <a href="{{ route('business.discounts.index') }}" class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600">
                    Cancel
                </a>
