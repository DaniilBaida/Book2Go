<x-business-layout>
    <div class="p-6 bg-white shadow-sm sm:rounded-lg">
        ...
        <div class="flex justify-between items-center mt-6">
            <div>
                <button type="button" id="bulk-accept" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                    Accept Selected
                </button>
                <button type="button" id="bulk-deny" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                    Deny Selected
                </button>
            </div>
        </div>
