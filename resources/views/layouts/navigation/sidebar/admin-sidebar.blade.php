    ...
    <div id="sidebar"
        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            ...
            <a href="{{ route('admin.dashboard') }}" class="block">
                <x-application-logo x-bind:collapsed="!sidebarExpanded" />
            </a>
        </div>
        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    <!-- Dashboard -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] @if(Request::segment(1) === 'admin' && Request::segment(2) === 'dashboard') from-blue-500/[0.12] to-blue-500/[0.04] @endif">
                        <a class="block text-gray-800 truncate transition @if(!(Request::segment(1) === 'admin' && Request::segment(2) === 'dashboard')) hover:text-gray-900 @endif" href="{{ route('admin.dashboard') }}">
                            <div class="flex items-center">
                                <svg class="shrink-0 fill-current @if(Request::segment(1) === 'admin' && Request::segment(2) === 'dashboard') text-blue-500 @else @endif" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                    ...
                    <!-- User Management -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] @if(Route::is('admin.users.index')) from-blue-500/[0.12] to-blue-500/[0.04] @endif">
                        <a class="block text-gray-800 truncate transition @if(!Route::is('admin.users.index')) hover:text-gray-900 @endif" href="{{ route('admin.users.index') }}">
                            <div class="flex items-center">
                                <svg class="shrink-0 fill-current @if(Route::is('admin.users.index')) text-blue-500 @else @endif" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
        ...
        <div class="pt-3 hidden lg:inline-flex 2xl:hidden justify-end mt-auto">
            <div class="w-12 pl-4 pr-3 py-2">
                <button @click="sidebarExpanded = !sidebarExpanded" class="text-gray-400 hover:text-gray-500 transition-colors">
                    <span class="sr-only">Expand / collapse sidebar</span>
                    <svg :class="{ 'rotate-180': sidebarExpanded }" class="shrink-0 fill-current text-gray-400 transition-transform duration-200" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
