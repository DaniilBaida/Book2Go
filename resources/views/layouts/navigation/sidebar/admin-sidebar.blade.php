    ...
    <div id="sidebar"
        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    <!-- Dashboard -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] @if(in_array(Request::segment(1), ['admin.dashboard'])){{ 'from-violet-500/[0.12] to-violet-500/[0.04]' }}@endif">
                        <a class="block text-gray-800 truncate transition @if(!in_array(Request::segment(1), ['admin.dashboard'])){{ 'hover:text-gray-900' }}@endif" href="{{ route('admin.dashboard') }}">
                            <div class="flex items-center">
                                <svg class="shrink-0 fill-current @if(in_array(Request::segment(1), ['admin.dashboard'])){{ 'text-violet-500' }}@else{{ 'text-gray-400' }}@endif" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                    ...
                    <!-- User Management -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] @if(in_array(Request::segment(1), ['admin.users.index'])){{ 'from-violet-500/[0.12] to-violet-500/[0.04]' }}@endif">
                        <a class="block text-gray-800 truncate transition @if(!in_array(Request::segment(1), ['admin.users.index'])){{ 'hover:text-gray-900' }}@endif" href="{{ route('admin.users.index') }}">
                            <div class="flex items-center">
                                <svg class="shrink-0 fill-current @if(in_array(Request::segment(1), ['admin.users.index'])){{ 'text-violet-500' }}@else{{ 'text-gray-400' }}@endif" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
