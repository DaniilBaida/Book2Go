    ...
    >
        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    <!-- Dashboard -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] @if(Request::segment(1) === 'business' && Request::segment(2) === 'dashboard') from-blue-500/[0.12] to-blue-500/[0.04] @endif">
                        <a class="block text-gray-800 truncate transition @if(!(Request::segment(1) === 'business' && Request::segment(2) === 'dashboard')) hover:text-gray-900 @endif" href="{{ route('business.dashboard') }}">
                            <div class="flex items-center">
                                <svg class="shrink-0 fill-current @if(Request::segment(1) === 'business' && Request::segment(2) === 'dashboard') text-blue-500 @else @endif" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                    ...
                    <!-- Services -->
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] @if(Route::is('business.services.index')) from-blue-500/[0.12] to-blue-500/[0.04] @endif">
                        <a class="block text-gray-800 truncate transition @if(!Route::is('business.services.index')) hover:text-gray-900 @endif" href="{{ route('business.services.index') }}">
                            <div class="flex items-center">
                                <svg class="shrink-0 fill-current @if(Route::is('business.services.index')) text-blue-500 @else @endif" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
