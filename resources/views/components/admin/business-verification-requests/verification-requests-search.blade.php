<div class="md:flex justify-between items-center mb-4">
    ...
    <div class="md:flex justify-between items-center mb-4 w-full">
        <form method="GET" action="{{ route('admin.business-verification-requests.index') }}" class="max-md:mb-6 flex items-center max-md:gap-y-2 w-full md:w-auto">
            <div class="relative">
            ...
            <div class="flex gap-2 justify-start mt-0">
                ...
                <!-- Clear Button -->
                @if(request('search'))
                    <a href="{{ route('admin.business-verification-requests.index') }}">
